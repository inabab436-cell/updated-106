...
describe("buildSystemPrompt", () => {
  it("embeds the given inventory verbatim under the Available-products section", () => {
    const inv = "- منتج تجريبي | لون: - | مقاس: - | كمية: 1 | سعر: 100";
    const prompt = buildSystemPrompt(inv);
